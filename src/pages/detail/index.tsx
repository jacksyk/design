      ...
      <div className="max-w-4xl mx-auto px-6">
        <div className="bg-white rounded-xl shadow-md p-8">
          ...
          <div className="border-t pt-8">
            <h2 className="text-xl font-bold text-indigo-800 mb-6">评论区</h2>
            ...
            <div className="mb-8">
              ...
              <div className="flex justify-end mt-4">
                <div className="bg-indigo-600 text-white px-6 py-2 rounded-lg hover:bg-indigo-700 transition-colors duration-300">
                  发表评论
                </div>
              </div>
            </div>
              ...
              {[1, 2, 3].map((item) => (
                <div key={item} className="border-l-4 border-gray-200 pl-4">
                  <div className="flex items-center space-x-3 mb-2">
                    <div className="w-8 h-8 rounded-full bg-gray-100 flexCenter">
                      用户
                    </div>
                    <div>
                      <span className="font-medium text-gray-800">李四</span>
